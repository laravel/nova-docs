---
title: 'Menus'
description: 'Nova menus provide a convenient way to customize the main and user menus.'
---
...
<Frame>
![Default Menu](/images/default-main-menu.png)
</Frame>
...
Nova will also automatically group your resources under the default "Resources" menu section according to the [`group` property defined in the `Resource` class](./../resources/index#grouping-resources). In addition, any custom tools you have registered will be listed in the order they are defined within your application's `NovaServiceProvider`.
