...
When Nova generates your card, `resources/js` and `resources/css` directories are generated for you. These directories contain your card's JavaScript and css stylesheets. The primary files of interest in these directories are: `resources/js/components/Card.vue` and `resources/css/card.scss`.
