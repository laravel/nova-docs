---
title: 'Authorization'
description: 'Nova leverages Laravel policies to authorize incoming requests.'
---
...
You can also run the command without any arguments or options and the console would prompts the required informations:
...
```php app/Policies/PodcastPolicy.php
use App\Models\User;
...
```php app/Nova/~Resource.php {19-21}
