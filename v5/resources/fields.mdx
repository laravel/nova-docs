...
You may allow a field to be visible [when peeking at the resource](/v5/resources/relationships#peeking-at-belongsto-relationships) by invoking the `showWhenPeeking` method when defining the field:
