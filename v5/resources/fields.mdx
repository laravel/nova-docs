...
<Frame>
![Audio Field](/images/audio-field.png)
</Frame>
...
<Frame>
![Avatar Search Results](/images/avatar-search-results.png)
</Frame>
...
<Frame>
![Heading Field](/images/heading-field.png)
</Frame>
...
<Frame>
![Key/Value Field](/images/key-value-field.png)
</Frame>
...
<Frame>
![Searchable Select Fields](/images/searchable-select.png)
</Frame>
...
<Frame>
![Status Field Example](/images/status-field-waiting.png)
</Frame>
...
<Frame>
![Stack Field](/images/stack-field.png)
</Frame>
...
<Frame>
![Line presentational methods](/images/stack-field-lines.png)
</Frame>
...
<Frame>
![Tag Field](/images/tag-field.png)
</Frame>

`Tag` fields will be displayed in a dropdown on the index view:

<Frame>
![Tag Field on index views](/images/tag-field-index.png)
</Frame>
...
<Frame>
![Previewing Tags](/images/previewing-tags.png)
</Frame>
...
<Frame>
![Tag field displayed as a list](/images/tag-field-list-index.png)
</Frame>

<Frame>
![Tag field displayed as a list](/images/tag-field-list-edit.png)
</Frame>
...
<Frame>
![Creating Tags Inline](/images/tag-field-with-create-relation.png)
</Frame>
...
<Frame>
![Field Suggestions](/images/field-suggestions.png)
</Frame>
...
Textarea::make('Excerpt')->withMeta([
...
While [readonly fields](#readonly-fields) disable the field's corresponding input, you may wish to still allow the field value to be submitted with the form. To allow this, you may invoke the `immutable` method on the field instead of the `readonly` method. You may pass a boolean argument to the `immutable` method to dynamically control whether a field should be immutable:
...
Text::make('Email')
    ->immutable(optional($this->resource)->trashed()),
```

You may also pass a closure to the `immutable` method. The result of the closure will be used to determine if the field should be immutable. The closure will receive the current `NovaRequest` as its first argument:
...
Text::make('Email')
    ->immutable(fn ($request) => ! $request->user()->isAdmin()), 
```
...
<Frame>
![Required Fields](/images/required-field.png)
</Frame>
