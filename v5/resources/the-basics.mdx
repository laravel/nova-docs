...
```php app/Observers/PostObserver.php {15}
...
```php app/Providers/AppServiceProvider.php {2,13}
use App\Models\User;
...
```php app/Providers/AppServiceProvider.php {2,14}
use App\Models\User;
