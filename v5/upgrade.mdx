...
Next you will need to update your Nova configuration file. First, ensure that the `api_middleware` configuration option within your application's `nova` configuration file appears as follows:
