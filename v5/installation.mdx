...
- Inertia.js v2 (JavaScript) and compatible with Inertia Laravel v1 and v2
- Laravel Mix 6
...
Finally, you can run `nova:publish` to publish the required Fortify migrations if it's not available yet and run `migrate` to ensure database migrations contains the correct schema:
