...
description: 'Learn how to define metrics in Nova.'
---
...
```php app/Nova/Metrics/NewUsers.php
...
```php app/Nova/Metrics/~Metric.php
use App\Models\Post;
use Laravel\Nova\Http\Requests\NovaRequest;
use Laravel\Nova\Metrics\ValueResult;
...
```php app/Nova/Metrics/~Metric.php {12}
use Laravel\Nova\Http\Requests\NovaRequest;
use Laravel\Nova\Metrics\ValueResult;
...
```php app/Nova/Metrics/~Metric.php {13-14}
use App\Models\Order;
use Laravel\Nova\Http\Requests\NovaRequest;
use Laravel\Nova\Metrics\ValueResult;
...
```php app/Nova/Metrics/~Metric.php {13}
...
```php app/Nova/Metrics/~Metric.php {11}
use Laravel\Nova\Http\Requests\NovaRequest;
use Laravel\Nova\Metrics\ValueResult;
...
```php app/Nova/Metrics/UsersPerDay.php
namespace App\Nova\Metrics;
...
<Frame>
![Latest Value](/images/latest-value.png)
</Frame>
...
<Frame>
![Partition Metric](/images/partition.png)
</Frame>
...
```php app/Nova/Metrics/UsersPerPlan.php
namespace App\Nova\Metrics;
...
```php app/Nova/Metrics/~Metric.php {18}
use App\Models\User;
use Laravel\Nova\Http\Requests\NovaRequest;
use Laravel\Nova\Metrics\Progress;
use Laravel\Nova\Metrics\ProgressResult;
...
```php app/Nova/Metrics/NewReleases.php
namespace App\Nova\Metrics;
...
<Frame>
![Table Actions](/images/table-actions.jpg)
</Frame>
...
<Note>
You can learn more about menu customization by reading the [menu item customization documentation](/v5/customization/menus#menu-items).
</Note>
