...
Further reading is available on the ([Tabs](./resources/panels#tabs)) documentation.

## Fields & Filters Improvements

### Allow to disable cascading Dependent Field sync

[documentation](./resources/dependent-fields#disable-cascading-dependent-field-sync-event)
### New Dependent Computed Field via `Field::computed()` method

[documentation](./resources/dependent-fields#dependable-computed-fields)

### New `Field::immutable()` method

[documentation](./resources/fields#immutable-fields)
