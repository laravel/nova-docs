...
With the release of Nova 5, we also build a new first-party Nova Component to allow you to view and configure Pennant directly within Nova's UI. To use the component you need to install the component using the following command:
