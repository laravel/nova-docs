---
title: 'Impersonation'
description: 'Learn how to impersonate other users in your application.'
---
...
```php app/Providers/EventServiceProvider.php {2-3,14-16,18-20}
