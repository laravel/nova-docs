---
title: 'Localization'
description: 'Learn how to localize your Nova application.'
---
...
```php app/Nova/Filters/~Filter.php
/**
...
```php app/Providers/NovaServiceProvider.php {9}
/**
 * Boot any application services.
 */
public function boot(): void
...
```php app/Providers/NovaServiceProvider.php {9-11}
/**
 * Boot any application services.
 */
public function boot(): void
