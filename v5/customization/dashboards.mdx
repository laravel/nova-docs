...
```php Providers/NovaServiceProvider.php
...
```diff Providers/NovaServiceProvider.php
use App\Nova\Dashboards\Main;
use App\Nova\Dashboards\UserInsights;
...
```php Providers/NovaServiceProvider.php {14-16}
use App\Models\User;
use App\Nova\Dashboards\Main;
use App\Nova\Dashboards\UserInsights;
...
```php Providers/NovaServiceProvider.php {14}
use App\Models\User;
use App\Nova\Dashboards\Main;
use App\Nova\Dashboards\UserInsights;
