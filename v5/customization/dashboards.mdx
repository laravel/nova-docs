---
title: 'Dashboards'
description: 'Nova dashboards provide a convenient way to build information overview pages that contain a variety of metrics and cards.'
---
...
```php app/Nova/Dashboards/Main.php {13-18}
...
```php app/Nova/Dashboards/UserInsights.php
namespace App\Nova\Dashboards;
...
```php app/Providers/NovaServiceProvider.php {13}
use App\Nova\Dashboards\Main;
use App\Nova\Dashboards\UserInsights;
...
```php app/Providers/NovaServiceProvider.php {14-16}
use App\Models\User;
use App\Nova\Dashboards\Main;
use App\Nova\Dashboards\UserInsights;
...
```php app/Providers/NovaServiceProvider.php {14}
use App\Models\User;
use App\Nova\Dashboards\Main;
use App\Nova\Dashboards\UserInsights;
