...
After purchasing a Nova 4.0 license, you should update your [Composer auth.json file](https://getcomposer.org/doc/articles/http-basic-authentication) to use your newly generated license key instead of your previous Nova 3 API token or account password.
...
Please refer to our documentation regarding [timezone customization](./resources/date-fields#customizing-the-timezone) for more information.
...
Further detail regarding Nova authorization is available within the [resource policy documentation](./resources/authorization#policies) and [action authorization documentation](./actions/registering-actions#authorization).
