...
Your Nova tool is generated with an `Authorize` middleware. This middleware automatically determine that the authenticated user can "see" the tool before it processes any requests to routes within your tool's route group; however, you are free to modify this middleware if needed.
